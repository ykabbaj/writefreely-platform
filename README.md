...
`WRITEFREELY_ADMIN_USER` / `WRITEFREELY_ADMIN_PASSWORD`. Use
`make admin-bootstrap` if the configured account needs to be created or reset
later. Do not use `admin` as the username; WriteFreely reserves it.
